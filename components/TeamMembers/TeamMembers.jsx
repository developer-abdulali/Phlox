...
const TeamMembers = () => {
  return (
    <div className="max-w-screen-2xl mx-auto flex flex-col-reverse lg:flex-row justify-between mt-10">
...
//         <p className="text-xl mt-7 text-[#505050d4]">
...
//         <Image src="/images/teamMember1.jpeg" alt="Team Member" width={300} height={100} className="rounded-xl"/>
